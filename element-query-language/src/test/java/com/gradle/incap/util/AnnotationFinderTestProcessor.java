...
/**
 * Allows testing {@link AnnotationFinder} by running the annotationFinder during annotation
 * processing. This mechanism is required as we can't mock the elements of annotation processing.
 */
