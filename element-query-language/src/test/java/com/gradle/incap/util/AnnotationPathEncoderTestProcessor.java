...
/**
 * Allows testing {@link AnnotationPathEncoder} by running the annotationPathEncoder during
 * annotation processing. This mechanism is required as we can't mock the elements of annotation
 * processing.
 */
